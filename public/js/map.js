...
const WORLD_PLACES = [
  ...
  { name: 'HSR Layout', zone: 'Bangalore', coords: [12.9121, 77.6446], aliases: ['hsr'] },
  { name: 'Church Street', zone: 'Bangalore', coords: [12.9756, 77.605], aliases: [] },
  { name: 'Electronic City', zone: 'Bangalore', coords: [12.8399, 77.677], aliases: ['ecity'] },
  ...
  { name: 'Koregaon Park', zone: 'Pune', coords: [18.5362, 73.8939], aliases: ['kp'] },
  { name: 'FC Road', zone: 'Pune', coords: [18.5284, 73.8417], aliases: ['fergusson'] },
  { name: 'Hinjewadi', zone: 'Pune', coords: [18.5913, 73.738], aliases: [] },
  { name: 'Baner', zone: 'Pune', coords: [18.559, 73.7868], aliases: [] },
  { name: 'Hyderabad', zone: 'Telangana, India', coords: [17.385, 78.4867], aliases: ['hyd'] },
  { name: 'HITEC City', zone: 'Hyderabad', coords: [17.4474, 78.3762], aliases: ['hitec', 'hitech'] },
  { name: 'Jubilee Hills', zone: 'Hyderabad', coords: [17.4319, 78.4071], aliases: [] },
  { name: 'Gachibowli', zone: 'Hyderabad', coords: [17.4401, 78.3489], aliases: [] },
  { name: 'Charminar', zone: 'Hyderabad', coords: [17.3616, 78.4747], aliases: [] },
